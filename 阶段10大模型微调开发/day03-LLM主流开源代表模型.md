...
Qwen不仅是语言模型，更是**通用人工智能（AGI）**技术栈，包含：

- **LLM**：Qwen-1.5/2/2.5系列
- **LMM**：Qwen-VL多模态模型
- **Agent**：工具调用与任务规划能力
- **长文本**：业界首个1M上下文开源模型
...
| 技术模块       | Qwen1.5 | Qwen2         | Qwen2.5    | 创新价值           |
| :------------- | :------ | :------------ | :--------- | :----------------- |
| **注意力机制** | 标准MHA | GQA（大模型） | 全系列GQA  | 推理显存降低50%    |
| **上下文长度** | 32K     | 128K          | 1M tokens  | 长文档处理能力领先 |
| **训练数据**   | 未公开  | 7T tokens     | 18T tokens | 质量与规模双提升   |
| **多模态**     | 基础版  | Qwen2-VL      | Qwen2.5-VL | 文档理解SOTA       |
...
由李开复博士创立的零一万物（01.AI）打造，专注于**性能与效率的最佳平衡**，特别优化代码生成与长文本理解。
...
| 版本         | 参数规模  | 发布时间 | 定位     | 核心能力                 |
| :----------- | :-------- | :------- | :------- | :----------------------- |
| **Yi-34B**   | 34B       | 2023.11  | 旗舰模型 | AlpacaEval 2.0榜单领先   |
| **Yi-1.5**   | 6B/9B/34B | 2024.05  | 效率优化 | 推理速度提升30%          |
| **Yi-Coder** | 1.5B/9B   | 2024.09  | 代码专用 | 支持128K上下文，52种语言 |
