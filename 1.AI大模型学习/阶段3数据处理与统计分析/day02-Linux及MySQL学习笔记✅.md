...
| **注册端口** | 1024-49151  | **用户级应用程序或服务**的监听端口，方便客户端寻址（例如：MySQL/3306）。 |
| **动态端口** | 49152-65535 | **客户端操作系统临时分配**的端口，用于发起对外连接，数据返回时据此区分归属。 |
...
<img src="assets\image-20250425130250957.png" alt="image-20250425130250957"  />
