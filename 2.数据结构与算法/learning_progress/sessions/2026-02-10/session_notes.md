...
| 日期 | 复习内容 | 状态 |
|:-----|:---------|:-----|
| 2026-02-11 | Day 31: 虚拟头节点 + LeetCode 21 | ✓ 知识点完全巩固，4个问答全部正确 |

**复习问答记录**：
1. ✓ 虚拟头节点的 `val` 值不重要，因为返回的是 `dummy.next`
2. ✓ `dummy.next` 是真正的头节点
3. ✓ 无虚拟头节点需判断空链表和确定真正的头节点
4. ✓ `curr = dummy` 可以统一后续挂接节点逻辑代码
