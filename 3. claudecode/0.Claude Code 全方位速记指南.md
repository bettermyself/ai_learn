# Claude Code 全方位速记指南 (The Shorthand Guide)

**背景**：基于作者 10 个月的日常使用经验（从 2 月份实验性推出开始），以及赢得 Anthropic x Forum Ventures 黑客马拉松的实战总结。
...
- **示例**：
  - `codemap-updater.md`: 在检查点更新代码地图，方便 Claude 导航而不消耗过多上下文。
