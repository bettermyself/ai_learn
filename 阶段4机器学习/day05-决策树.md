...
![image-20230905142204113](assets/image-20230905142204113.png)

1.计算熵

![image-20230905142647180](assets/image-20230905142647180.png)

2.计算性别条件熵(a="性别")：

![image-20230905142707392](assets/image-20230905142707392.png)

计算性别信息增益(a="性别")

![image-20230905142723434](assets/image-20230905142723434.png)

3. 计算活跃度条件熵(a=“活跃度")

![image-20230905142802304](assets/image-20230905142802304.png)

计算活跃度信息增益(a=活跃度")

![image-20230905142825748](assets/image-20230905142825748.png)

**结论**：活跃度的信息增益比性别的信息增益大，对用户流失的影响比性别大。

![image-20230914160802488](assets/image-20230914160802488.png)
...
![image-20230905150018847](assets/image-20230905150018847.png)
...
![image-20230905150001475](assets/image-20230905150001475.png)
...
<img src="assets/image-20230905153217302.png" alt="image-20230905153217302" style="zoom:50%;" />
...
![image-20230905155453855](assets/image-20230905155453855.png)
...
为什么需要吧婚姻状况分成两类，是因为二叉树。

#### 年收入

先将数值型属性升序排列，以相邻中间值作为待确定分裂点：

![image-20230905153041427](assets/image-20230905153041427.png)
...
![image-20230905161031728](assets/image-20230905161031728.png)
...
- 信息增益
  ...
  <img src="assets/image-20240803101336688.png" alt="image-20240803101336688" style="zoom:67%;" />

- **CART 决策树原理** 

<img src="assets/image-20240803113408798.png" alt="image-20240803113408798" style="zoom:50%;" />
